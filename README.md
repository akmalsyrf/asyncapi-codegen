...
go get -u github.com/akmalsyrf/asyncapi-codegen/pkg/extensions
```
...
```golang
//go:generate go run github.com/akmalsyrf/asyncapi-codegen/cmd/asyncapi-codegen@<version> -i ./asyncapi.yaml -p <your-package> -o ./asyncapi.gen.go
```
...
```bash
docker run -v .:/code -w /code akmalsyrf/asyncapi-codegen asyncapi-codegen -i ./asyncapi.yaml -p <your-package> -o ./asyncapi.gen.go
```
